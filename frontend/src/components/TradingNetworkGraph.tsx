...
const MIN_LINK_WIDTH = 0.6; // Slightly thicker minimum link width
...
// --- Main Component ---
const TradingNetworkGraph: React.FC<TradingNetworkGraphProps> = ({ tradingNetwork, width, height }) => {
    ...
    const calculateLinkWidth = (link: LinkObject) => {
        const scale = Math.log1p(link.value) / Math.log1p(maxLinkValue);
        // Use updated MIN/MAX constants
...
export default TradingNetworkGraph;
