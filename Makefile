...
ifeq ($(DETECTED_OS),Windows)
	...
	@powershell -Command "[Environment]::SetEnvironmentVariable('Path', [Environment]::GetEnvironmentVariable('Path', 'User') + ';%APPDATA%\Python\Scripts', 'User')"
	@echo "Running Poetry install..."
	@powershell -Command "%APPDATA%\Python\Scripts\poetry.exe install"
